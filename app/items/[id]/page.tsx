  ...
  if (!item) {
    return (
      <section className="rounded-lg bg-white p-6 shadow-sm ring-1 ring-campus-ink/10">
        ...
        <p className="mt-3 text-slate-700">The requested item does not exist in the current demo data set.</p>
        <Link href="/" className="mt-4 inline-flex min-h-12 items-center justify-center rounded-md bg-campus-moss px-4 py-3 font-black text-white hover:bg-campus-ink">
          Back to listings
        </Link>
      </section>
    );
